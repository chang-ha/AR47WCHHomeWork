...
ConsoleGameMath ConsoleGameScreen::GetScreenSize()
{
	return ConsoleGameMath{ ScreenXSize, ScreenYSize };
}
...
bool ConsoleGameScreen::IsScreenOver(const ConsoleGameMath& _Pos) const
{
	if (0 > _Pos.X)
	{
		return true;
